...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? '💫😴Leo Hub😴💫' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Leo-kun♌💫😴😪' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? 'Leo-kun♌💫😴😪' : process.env.PACK_AUTHER.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS  || 'true' ,
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? '💫😴Leo Hub😴💫' : process.env.PACK_NAME.split(";")[1],
